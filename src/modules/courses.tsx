...
export default function Courses() {
  ...
  const language = [
    ...
    },
    {
      ...
      startingDate: new Date("June 15, 2021 16:00"),
      grades: [6, 7],
  ...
  const math = [
    ...
    },
    {
      ...
      startingDate: new Date("14 June 2021 15:00"),
      grades: [6],
    ...
    },
    {
      ...
      startingDate: new Date("14 June 2021 16:00"),
      grades: [7],
    ...
    },
    {
      ...
      startingDate: new Date("14 June 2021 17:00"),
      grades: [8],
  ...
  const ela = [
    ...
    }, 
    {
      ...
      startingDate: new Date("18 June 2021 16:00"),
      grades: [5, 8],
